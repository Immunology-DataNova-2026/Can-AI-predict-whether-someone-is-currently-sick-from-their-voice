...
SEED = 42
CSV, READ = "external_datasets/SVD/svd_boost_features.csv", {}
DROP, LABEL, GROUP = ["speaker", "label"], "label", "speaker"
POS, NEG, MODEL, AUDIO = "pathological", "healthy", "svm", True
MODEL_PKL = HERE / "models" / "svd_voice_disorder_svm.pkl"
...
def main():
    print("==", "Voice disorders (Saarbrucken SVD)", "==")
