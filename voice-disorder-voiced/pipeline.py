...
SEED = 42
CSV, READ = "external_datasets/VOICED/voiced_features.csv", {}
DROP, LABEL, GROUP = ["record", "is_pathological"], "is_pathological", None
POS, NEG, MODEL, AUDIO = "pathological", "healthy", "logreg", True
MODEL_PKL = HERE / "models" / "voiced_egemaps_logreg.pkl"
