...
SEED = 42
CSV, READ = "external_datasets/Parkinsons-UCI/parkinsons.data", {}
DROP, LABEL, GROUP = ["name", "status"], "status", "__name__"
POS, NEG, MODEL, AUDIO = "parkinsons", "healthy", "rf", False
MODEL_PKL = HERE / "models" / "parkinsons_uci_rf.pkl"
...
def main():
    print("==", "Parkinsons (Oxford/UCI, small)", "==")
